...
FFT_Implementation::~FFT_Implementation()
{
    ...
    try
    {
        ...
        LogE("fftw3_destroy_plan throwed an exception");
    }
}
                                     ...
                                     unsigned flags)
{
    ...
    try {
        ...
        LogE("fftw_pplan_dft_r2c_1d throwed an exception");
    }
}
                                     ...
                                     unsigned flags)
{
    ...
    try {
        ...
        LogE("fftw_pplan_dft_c2r_1d throwed an exception");
    }
}
...
void FFT_Implementation::calculateFFT  (const FFTRealVector &in, FFTComplexVector &out)
{
    ...
    try {
        ...
        LogE("fftw_execute throwed an exception");
    }
}
